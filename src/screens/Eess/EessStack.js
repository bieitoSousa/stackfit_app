...
import { EessScreen } from './EessScreen';
import { EessDetailScreen } from './EessDetailScreen';

export const EessStack = ({ navigation }) => {   
    ...
    >
        <Stack.Screen
            name="EessScreen"
            component={EessScreen}
            options={{ headerShown: false }}
        />
        <Stack.Screen
            name="EessDetailScreen"
            component={EessDetailScreen}
        />
    </Stack.Navigator>
    )
